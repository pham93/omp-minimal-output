...
export const WRAPPED_TOOL_REGISTRY = {
  ...
  lsp: { nativeKey: "nativeLsp", approval: STATIC_TOOL_APPROVAL.read },
  ast_grep: { nativeKey: "nativeAstGrep", approval: STATIC_TOOL_APPROVAL.read },
  security_scan: { nativeKey: "nativeSecurityScan", approval: STATIC_TOOL_APPROVAL.read },
  context_notes: { nativeKey: "nativeContextNotes", approval: STATIC_TOOL_APPROVAL.read },
  recall: { nativeKey: "nativeRecall", approval: STATIC_TOOL_APPROVAL.read },
  reflect: { nativeKey: "nativeReflect", approval: STATIC_TOOL_APPROVAL.read },
  debug: { nativeKey: "nativeDebug" },
  github: { nativeKey: "nativeGithub" },
  checkpoint: { nativeKey: "nativeCheckpoint" },
  rewind: { nativeKey: "nativeRewind" },
  new_context: { nativeKey: "nativeNewContext" },
  memory_edit: { nativeKey: "nativeMemoryEdit" },
  retain: { nativeKey: "nativeRetain" },
  learn: { nativeKey: "nativeLearn" },
  manage_skill: { nativeKey: "nativeManageSkill" },
...
export const DEFAULT_CONFIG: PluginConfig = {
  ...
  nativeRewind: false,
  nativeNewContext: false,
  nativeMemoryEdit: false,
  nativeRetain: false,
  nativeLearn: false,
  nativeManageSkill: false,
  nativeTask: false,
  taskMaxAgents: 4,
  nativeHub: false,
  hubMaxItems: 5,
